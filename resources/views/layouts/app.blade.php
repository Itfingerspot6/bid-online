...
<body class="bg-[#09090b] text-zinc-100 min-h-screen selection:bg-amber-400 selection:text-zinc-950">
    ...
    <div x-data="{ 
         ...
         class="fixed bottom-10 right-10 z-[100] flex flex-col gap-3">
        <template x-for="msg in messages" :key="msg.id">
            <div x-transition:enter="transition ease-out duration-300"
                 ...
                 class="bg-zinc-900 border border-amber-400/20 text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 backdrop-blur-xl">
                ...
                <span class="text-sm font-medium" x-text="msg.text"></span>
            </div>
        </template>
    </div>
